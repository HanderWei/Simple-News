...
public class TencentFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
//        ((MaterialNavigationDrawer) getActivity()).changeToolbarColor(R.color.tencent_colorPrimary,
//                                                                      R.color.tencent_colorPrimaryDark);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_tencent, container, false);
        mTabs = (PagerSlidingTabStrip) rootView.findViewById(R.id.tencent_tabs);
        mPager = (ViewPager) rootView.findViewById(R.id.tencent_pager);
