...
public class NetEasyFragment extends Fragment {
    ...
    public void onResume() {
        super.onResume();
//        ((MaterialNavigationDrawer) getActivity()).changeToolbarColor(R.color.neteasy_colorPrimary,
//                                                                      R.color.neteasy_colorPrimaryDark);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_net_easy, container, false);
        mTabs = (PagerSlidingTabStrip) rootView.findViewById(R.id.net_easy_tabs);
        mPager = (ViewPager) rootView.findViewById(R.id.net_easy_pager);
